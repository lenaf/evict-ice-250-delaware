...
export const JACOBS_DONATIONS: PowerMapDonation[] = [
  { person: "Jeremy Sr.", recipient: "Trump Victory", amount: "$100,000", period: "2016", jurisdiction: "federal", photo: "/photos/politicians/trump.jpg", detail: "Jeremy Jacobs Sr. to Trump's 2016 joint fundraising committee.", href: "https://www.fec.gov/data/receipts/?contributor_name=Jacobs&contributor_employer=Delaware+North" },
  { person: "Jeremy Sr.", recipient: "Gov. Kathy Hochul", amount: "$401,854 (family)", period: "since 1999", jurisdiction: "state", photo: "/photos/politicians/hochul.jpg", detail: "Family total to Hochul's campaigns since 1999 (NY State Board of Elections).", href: "https://data.ny.gov/d/4j2b-6a2j" },
  ...
  { person: "Jerry Jr.", recipient: "Rep. Hakeem Jeffries", amount: "$17,000 (family)", period: "2024–25", jurisdiction: "federal", photo: "/photos/politicians/jeffries.jpg", detail: "U.S. House Democratic Leader · family total.", href: "https://www.fec.gov/data/receipts/?contributor_name=Jacobs&contributor_employer=Delaware+North" },
