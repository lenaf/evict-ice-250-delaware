...
export async function Footer() {
  ...
  const orgName = siteSettings.siteName || "Evict ICE from 250 Delaware";
  const tagline = siteSettings.tagline || "Standing up against ICE presence in our community";

  // Static footer links
  const footerLinks = [
    { title: "Home", slug: "" },
    { title: "About", slug: "about" },
    { title: "Take Action", slug: "take-action" },
  ];
    ...
    <footer className="bg-neutral text-neutral-content py-12">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          {/* Connect Section */}
          <div>
            <h3 className="font-bold text-lg mb-4 font-heading">Connect</h3>
            <p className="opacity-80 mb-4">Follow us for updates and events</p>
